        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('• ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ •', url ='https://t.me/IBMMovieReq')
                        ]]
                    )
                )
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("• ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ • ​ ", url=f"https://t.me/IBMMovieReq")]]), disable_web_page_preview=True
    )
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("ᴘʀᴇᴍɪᴜᴍ", url=f"https://t.me/IBMBotSupport"),
            InlineKeyboardButton("sᴇɴᴅ ᴀʟʟ", callback_data=f"sendfiles#{key}")
        ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="hhttps://t.me/IBMMovieReq")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/IBMMovieReq")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @cryxelys
        ...
        buttons = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ʜᴇʀᴇ', user_id=int(2125687935))
        ],[
        ...
        btn = [[
            InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(2125687935))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('☎️ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ', user_id=int(2125687935))
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('× OWNED BY ×', url="https://t.me/simpshh")
       ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ •', url="t.me/IBMBotSupport"),
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs •', url="t.me/WholesomeCity")
       ],[
            InlineKeyboardButton('• sᴇʀɪᴇs •', url="https://t.me/IBMMovieReq"),
            InlineKeyboardButton('• ᴍᴏᴠɪᴇ •', url="https://t.me/IBMMovieReq")
       ],[
            InlineKeyboardButton('• 18+ Verse •', url="https://t.me/DelightNetwork")
       ],[ 
            InlineKeyboardButton('• ʙᴀᴄᴋ •', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            ...
            InlineKeyboardButton ('• ᴠɪsɪᴛ ᴏᴜʀ ᴄᴏᴍᴍᴜɴɪᴛʏ •', url="t.me/WholesomeCity"),
        ], [
            InlineKeyboardButton('• ᴏᴡɴᴇʀ •', user_id=int(2125687935)),
