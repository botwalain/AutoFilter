...
BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton('SUPPORT', url='https://t.me/IBMBotSupport')]])
...
ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴊᴏɪɴ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ <a href='https://t.me/IBMMovieReq'>ᴄʟɪᴄᴋ</a>
...
𝐂𝐡𝐞𝐜𝐤 𝐒𝐜𝐫𝐞𝐞𝐧𝐬𝐡𝐨𝐭 <a href='https://envs.sh/zfB.jpg'>𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞⚡️</a>
𝐎𝐰𝐧𝐞𝐫 𝐍𝐚𝐦𝐞 :- {}
𝐆𝐫𝐨𝐮𝐩 𝐍𝐚𝐦𝐞 :- {}
"""
...
#   album_id = r.json()[0]["albumid"]
    ...
    buttons = [[
        InlineKeyboardButton("ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴊᴏɪɴ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ", url="https://t.me/IBMMovieReq")
    ]]                           
    await message.reply_video(
    video=ffile, caption=f"[{sname}]({r['data']['results'][0]['url']}) - from @WholesomeCity ",thumb=thumbnail,
...
async def r_message(client, message):
    ...
    buttons = [[
        InlineKeyboardButton('𝐉𝐨𝐢𝐧 𝐆𝐫𝐨𝐮𝐩', url=f'https://t.me/IBMMovieReq')
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
